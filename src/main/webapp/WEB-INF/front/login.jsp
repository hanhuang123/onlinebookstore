...
<div id="header" class="wrap">
    ...
    <div class="help">
        ...
        <c:if test="${sessionScope.user!=null}"><a
                href="userOrder.do?uid=${sessionScope.user.uid}">我的订单</a>&nbsp;用户:${sessionScope.user.uname}&nbsp;&nbsp;<a href="updateUserPage.do">更新個人資料</a><a href="updatePwdPage.do">修改密碼</a><a href="logout.do">刪除</a></c:if>
        ...
        <div class="box">
            ...
            <form id="loginForm">
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td><input class="btn btn-success" type="button" id="submit" value="登錄"/></td>
                    </tr>
                </table>
            </form>
        </div>
