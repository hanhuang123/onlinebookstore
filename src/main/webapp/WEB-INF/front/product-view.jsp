...
<div id="header" class="wrap">
	...
	<div class="help">
		...
		<c:if test="${sessionScope.user!=null}"><a href="userOrder.do?uid=${sessionScope.user.uid}">我的訂单</a>&nbsp;用户:${sessionScope.user.uname}&nbsp;&nbsp;<a href="updateUserPage.do">更新個人資料</a><a href="updatePwdPage.do">修改密码</a><a href="logout.do">刪除</a></c:if>
	...
	<div id="product" class="main">
		...
		<div class="infos">
			...
			<div class="buy">
				...
				<p>出版日期：${dateStr}</p>
				<p>庫　存：${book.store}</p>
				<p>購買数量：<span id="sub" onclick="subNum();"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></span>&nbsp;
