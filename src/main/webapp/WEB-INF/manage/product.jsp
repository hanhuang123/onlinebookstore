					...
					<ul class="clearfix">
						<c:choose>
							<c:when test="${pageInfo.hasPreviousPage}">
								<li><a href="manaBook.do?pageNum=1">首頁</a></li>
								<li><a href="manaBook.do?pageNum=${pageInfo.prePage }">上一頁</a></li>
							</c:when>
							<c:otherwise>
								<li><span>首頁</span></li>
								<li><span>上一頁</span></li>
						...
						<c:choose>
							<c:when test="${pageInfo.hasNextPage}">
								<li><a href="manaBook.do?pageNum=${pageInfo.nextPage }">下一頁</a></li>
								<li><a href="manaBook.do?pageNum=${pageInfo.pages }">尾頁</a></li>
							</c:when>
							<c:otherwise>
								<li><span>下一頁</span>下一頁</li>
								<li><span>尾頁</span></li>
							</c:otherwise>
						</c:choose>
					</ul>
