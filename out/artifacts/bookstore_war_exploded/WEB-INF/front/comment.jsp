...
<div id="header" class="wrap">
	...
	<div class="help">
		...
		<c:if test="${sessionScope.user!=null}"><a href="userOrder.do?uid=${sessionScope.user.uid}">我的訂單</a>&nbsp;用户:${sessionScope.user.uname}&nbsp;&nbsp;<a href="updateUserPage.do">更新個人資訊</a><a href="updatePwdPage.do">修改密碼</a><a href="logout.do">刪除</a></c:if>
...
<div id="reply-box">
				<form action="addComment.do">
					<table>
						...
						<tr>
							<td></td>
							<td><label class="ui-blue"><input type="submit" name="submit" value="送出評價" /></label></td>
						</tr>
					</table>
				</form>
			</div>
